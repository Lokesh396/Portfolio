...
import { heroName, heroposition } from "../utils/data";
const ProjectCard = ({ project }) => {
  const redirectTo = useRedirect()
  return (
    <div className="group grid grid-cols-1 md:grid-cols-4 gap-4 py-6 px-2 border-gray-700 hover:bg-teal-200/10 rounded-md cursor-pointer" onClick={()=>redirectTo(project.homepage)}>
      <img src={project.image} className="mt-2 border-white border" alt={heroName + " " + heroposition} />
